...
2. 국가 표준 보안 모델 : KISA
	  - 자율운항 선박 보안 모델 : IMO 자율운항 등급(Level 3) 기반, 운항 시나리오별 위협 분석 및 대응 절차 체계화
	  - 스마트선박 보안 모델 해설서 : IACS UR E26,E27 및 글로벌 화주의 보안 요구사항에 대응 가능한 국내 실무형 보안 기준 제시
	  - 해운 보안 요구사항 가이드라인 및 선원 8대 보안 수칙 : 현장 선원 및 선사에 직접 적용 가능한 실무 지침 보급
3. 선급 인증 및 검사 기준 : KR(한국 선급)
	- 해상 사이버보안 시스템 지침 & 선박 자동화 시스템 사이버복원력 승인/검사 가이드